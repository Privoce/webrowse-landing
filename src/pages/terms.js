    ...
    return (
        <div class="en section_container active" section-language="en">
            <div id="md_en" data-target="out_en" class="agreement_md">
                ...
                <ul>
                    ...
                    <li>
                        <p>
                            ...
                            "We", "Us" or "Our" in this Agreement) refers to privoce.
                        </p>
                    </li>
                    <li>
                        <p>
                    ...
                    <li>
                        <p>
                            <strong>Website</strong> refers to privoce, accessible from
                            <a href="https://www.termsfeed.com/live/privoce.com" rel="external nofollow noopener" target="_blank">privoce.com</a>
                        </p>
                    </li>
                    <li>
                        <p>
                ...
                <h1>On Google User Data</h1>
                <p>Additional Limits on Use of Your Google User Data: Notwithstanding anything else in this Privacy Policy, if you provide the App access to the following types of your Google data, the App's use of that data will be subject to these additional restrictions:
                </p>
                <p>The App will only use access to read, write, modify, or control Gmail message bodies (including attachments), metadata, headers, and settings to provide a web email client that allows users to compose, send, read, and process emails and will not transfer this Gmail data to others unless doing so is necessary to provide and improve these features, comply with applicable law, or as part of a merger, acquisition, or sale of assets.
                </p>
                <p>The App will not use this Gmail data for serving advertisements.
                </p>
                <p>The App will not allow humans to read this data unless we have your affirmative agreement for specific messages, doing so is necessary for security purposes such as investigating abuse, to comply with applicable law, or for the App's internal operations and even then only when the data have been aggregated and anonymized.</p>
                <p></p>
